...
class API_Configuration:
     def __init__(self):
        ...
        self.CONFIG_FILE = os.path.dirname(os.path.realpath(__file__))+"/config/api.properties"
        ...
        self.LIMIT_UPPER = int(self.PROPERTIES['LIMIT_UPPER'])
        self.LIMIT_DOWN = int(self.PROPERTIES['LIMIT_DOWN'])
